[dotenv@17.2.2] injecting env (11) from .env -- tip: 🔐 prevent committing .env to code: https://dotenvx.com/precommit
-- CreateSchema
...
-- CreateEnum
CREATE TYPE "public"."BookingType" AS ENUM ('CONFIRMED', 'TENTATIVE', 'BLOCKED', 'MAINTENANCE', 'OWNER', 'OWNER_STAY', 'CONTRACT');

-- CreateEnum
CREATE TYPE "public"."BookingStatus" AS ENUM ('PENDING', 'CONFIRMED', 'CANCELLED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "public"."BookingSource" AS ENUM ('MANUAL', 'EXTERNAL', 'IMPORT', 'WEBSITE');

-- CreateEnum
CREATE TYPE "public"."AvailabilityRequestStatus" AS ENUM ('PENDING', 'CONFIRMED', 'REJECTED');

-- CreateEnum
CREATE TYPE "public"."AvailabilityRequestUrgency" AS ENUM ('LOW', 'MEDIUM', 'HIGH');
...
CREATE TABLE "public"."PropertyContact" (
    ...
    "phone" TEXT,
    "notes" TEXT,
    "spokenLanguage" TEXT DEFAULT 'English',
    "isContractSignatory" BOOLEAN NOT NULL DEFAULT false,
    "metadata" JSONB,
...
CREATE TABLE "public"."Booking" (
    ...
    "source" "public"."BookingSource" NOT NULL DEFAULT 'MANUAL',
...
CREATE TABLE "public"."AvailabilityRequest" (
    ...
    "message" TEXT,
    "status" "public"."AvailabilityRequestStatus" NOT NULL DEFAULT 'PENDING',
    "urgency" "public"."AvailabilityRequestUrgency" NOT NULL DEFAULT 'MEDIUM',
...
-- CreateIndex
CREATE INDEX "Property_maxGuests_idx" ON "public"."Property"("maxGuests");

-- CreateIndex
CREATE INDEX "Property_numberOfRooms_numberOfBathrooms_idx" ON "public"."Property"("numberOfRooms", "numberOfBathrooms");

-- CreateIndex
CREATE INDEX "Property_status_destinationId_idx" ON "public"."Property"("status", "destinationId");

-- CreateIndex
CREATE INDEX "Property_eventsAllowed_idx" ON "public"."Property"("eventsAllowed");
...
-- CreateIndex
CREATE INDEX "PropertyContact_propertyId_type_idx" ON "public"."PropertyContact"("propertyId", "type");

-- CreateIndex
CREATE INDEX "PropertyContact_isApproved_idx" ON "public"."PropertyContact"("isApproved");

-- CreateIndex
CREATE INDEX "PropertyContact_isContractSignatory_idx" ON "public"."PropertyContact"("isContractSignatory");
...
-- CreateIndex
CREATE INDEX "AvailabilityRequest_propertyId_idx" ON "public"."AvailabilityRequest"("propertyId");

-- CreateIndex
CREATE INDEX "AvailabilityRequest_status_idx" ON "public"."AvailabilityRequest"("status");

-- CreateIndex
CREATE INDEX "AvailabilityRequest_createdAt_idx" ON "public"."AvailabilityRequest"("createdAt");

-- CreateIndex
CREATE INDEX "AvailabilityRequest_startDate_endDate_idx" ON "public"."AvailabilityRequest"("startDate", "endDate");
...
-- CreateIndex
CREATE INDEX "PriceRange_propertyId_nightlyRate_idx" ON "public"."PriceRange"("propertyId", "nightlyRate");
...
-- CreateIndex
CREATE INDEX "Photo_propertyId_isMain_idx" ON "public"."Photo"("propertyId", "isMain");

-- CreateIndex
CREATE INDEX "Photo_propertyId_position_idx" ON "public"."Photo"("propertyId", "position");
...
-- AddForeignKey
ALTER TABLE "public"."AvailabilityRequest" ADD CONSTRAINT "AvailabilityRequest_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "public"."Property"("id") ON DELETE CASCADE ON UPDATE CASCADE;
