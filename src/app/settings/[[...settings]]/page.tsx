  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-serif text-gray-900">Security Settings</h1>
          <p className="text-gray-600 mt-2">Manage your security preferences and authentication methods</p>
        </div>
