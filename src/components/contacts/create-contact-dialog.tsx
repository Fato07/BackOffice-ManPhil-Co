...
import { createContactSchema, type CreateContactData } from "@/lib/validations/contact"
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new contact to your database. Fill in the contact information below.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
